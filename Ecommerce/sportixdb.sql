...
*/
INSERT INTO `` (`id`,`fullName`,`email`,`idGender`,`password`,`birthday`,`phone`,`idCountry`,`idState`,`newsletter`,`file`,`idRoles`) VALUES (1,'Lionel Messi','messi@gmail.com',1,'$2a$10$ham2wC5vR5UL4n2oqLeCuuHgD1s1WBtTsZaXJw','1987-06-24',1510202020,1,2,'on','1654962009039_img.jpg',2);
INSERT INTO `` (`id`,`fullName`,`email`,`idGender`,`password`,`birthday`,`phone`,`idCountry`,`idState`,`newsletter`,`file`,`idRoles`) VALUES (2,'Juan Roman Riquelme','riquelme@gmail.com',1,'$2a$10$TIefwqRefVKQLwDemkvLMuK//TLPhGluFc/i6X','1987-06-24',1510101010,1,2,'on','1655056106130_img.jpg',1);
...
*/
INSERT INTO `` (`id`,`name`,`description`,`category`,`size`,`date`,`price`,`gender`,`brand`,`file`) VALUES (1,'Camiseta adidas Boca Juniors','Camiseta adidas Boca Juniors Primera Equipación 21/22',1,2,'2022-06-11',10999,1,1,'1654959687221_img_.jpg');
INSERT INTO `` (`id`,`name`,`description`,`category`,`size`,`date`,`price`,`gender`,`brand`,`file`) VALUES (2,'Zapatillas Puma R78 Future','De inspiración retro, pero con un estilo urbano y a la moda, las zapatillas iridiscentes R78 FUTURE son un básico moderno. Presentan un diseño de running tradicional, combinaciones de color originales y elementos de diseño clásicos. Este brillante modelo es impresionante.',2,8,'2022-06-13',7999,1,3,'1655151438981_img_.jpg');
INSERT INTO `` (`id`,`name`,`description`,`category`,`size`,`date`,`price`,`gender`,`brand`,`file`) VALUES (3,'Camiseta Nike FC Barcelona Primera Equipación','Anima a tu equipo con la camiseta de la primera equipación Match FC Barcelona. Está confeccionada con un tejido con capilarización del sudor para mantener la comodidad y la transpirabilidad tanto en el campo como en las gradas. Además, los detalles del equipo te permiten mostrar tu apoyo estés donde estés.',1,3,'2022-06-13',10800,1,2,'1655151512483_img_.jpg');
