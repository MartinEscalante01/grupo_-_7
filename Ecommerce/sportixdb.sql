...
INSERT INTO country (`id`,`name`) VALUES(6,'Brasil');
...
INSERT INTO productos (`id`,`name`,`description`,`category`,`size`,`date`,`price`,`gender`,`brand`,`file`) VALUES (16,"Bolso adidas Boca Juniors"," Para hinchas xeneixes de corazón y orgullosos de gritárselo al mundo, el Bolso adidas Boca Juniors es perfecto. Cuenta con un compartimento principal con cremallera, dos bolsillos externos y uno interno. así como también y una correa acolchada para el hombro para mayor comodidad. Incorpora un compartimento externo ventilado para calzado, dos asas de mano y una correa para el hombro que te facilita transportarlo.",1,1,"2022-08-17",7999,1,1,"1660582799650_img_.jpg");
