...
(14,"Zapatillas Topper Wind Iv","Las Zapatillas Topper Wind Iv cuentan con una capellada de cuero sintético de alta calidad para mejorar la sujeción y durabilidad del calzado. Su suela construida en goma protege las rodillas y su entresuela de EVA suaviza la presión de los impactos para mayor confort y seguridad en cada pisada.",2,18,"2022-02-09",12199,2,4,"1660413911312_img_.jpg");
(15,"Zapatillas Topper Jiro","Las zapatillas Topper Jiro están confeccionadas en materiales que la vuelven más liviana y duradera para el uso diario. Su ajuste con cordones se combina con una suela de goma que ofrece la adherencia que tus pisadas necesitan.",2,19,"2022-05-08",5599,2,4,"1660413993022_img_.jpg");
(16,"Bolso adidas Boca Juniors"," Para hinchas xeneixes de corazón y orgullosos de gritárselo al mundo, el Bolso adidas Boca Juniors es perfecto. Cuenta con un compartimento principal con cremallera, dos bolsillos externos y uno interno. así como también y una correa acolchada para el hombro para mayor comodidad. Incorpora un compartimento externo ventilado para calzado, dos asas de mano y una correa para el hombro que te facilita transportarlo.",3,1,"2022-08-17",6999,4,1,"1660582799650_img_.jpg");
